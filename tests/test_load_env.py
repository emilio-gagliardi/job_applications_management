...
from job_applications_management.app_utils import load_env
import pytest
import os
...
class TestLoadEnv:
    ...
    def test_env_var_set_maps_to_valid_env_file(self, mocker):
        ...
        mocker.patch(
            "os.path.dirname",
            return_value="C:/Users/emili/PycharmProjects/job_applications_management",
        )
        mocker.patch(
            "os.path.abspath",
            return_value="C:/Users/emili/PycharmProjects/job_applications_management/job_applications_management/app_utils.py",
        )
        mocker.patch(
            "os.path.join",
            return_value="C:/Users/emili/PycharmProjects/job_applications_management/.env.docker",
        )
        mock_load_dotenv = mocker.patch(
            "job_applications_management.app_utils.load_dotenv", return_value=True
        )
        ...
        mock_load_dotenv.assert_called_once_with(
            "C:/Users/emili/PycharmProjects/job_applications_management/.env.docker"
        )
    ...
    def test_env_var_set_to_invalid_value(self, mocker):
        ...
        mocker.patch(
            "os.path.join",
            return_value="C:/Users/emili/PycharmProjects/job_applications_management/.env.local",
        )
        mock_load_dotenv = mocker.patch(
            "job_applications_management.app_utils.load_dotenv", return_value=True
        )
        ...
        # Assert
        mock_load_dotenv.assert_called_once_with(
            "C:/Users/emili/PycharmProjects/job_applications_management/.env.local"
        )
    ...
    def test_env_file_does_not_exist(self, mocker):
        ...
        mocker.patch(
            "os.path.join",
            return_value="C:/Users/emili/PycharmProjects/job_applications_management/.env.nonexistent",
        )
        ...
        with pytest.raises(
            FileNotFoundError,
            match="The .env file at path C:/Users/emili/PycharmProjects/job_applications_management/.env.nonexistent does not exist.",
        ):
            load_env()
